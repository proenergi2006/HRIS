...
{{-- ── Hero ── --}}
<div class="hero">
    <img src="/img/logo-proenergi.png" alt="PT. Pro Energi" style="height:48px;object-fit:contain;margin-bottom:16px;filter:brightness(0) invert(1);display:block;margin-left:auto;margin-right:auto;">
