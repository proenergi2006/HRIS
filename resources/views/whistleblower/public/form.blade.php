...
{{-- ── Hero ── --}}
<div class="hero">
    <div style="display:inline-block;background:#fff;border-radius:10px;padding:8px 20px;margin-bottom:16px;">
        <img src="/img/propeople-icon.png" alt="ProPeople" style="height:40px;object-fit:contain;display:block;border-radius:9px;">
    </div>
