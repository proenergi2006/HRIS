...
<div class="form-row align-items-end">
  <div class="form-group col-12 col-md-4 mb-2">
    <label for="period_id" class="mb-1">Periode</label>
  ...
  <div class="form-group col-12 col-md-4 mb-2">
    <label for="search" class="mb-1">Cari Karyawan</label>
    <input type="text" name="search" id="search" class="form-control form-control-sm"
           placeholder="Nama karyawan..." value="{{ $search ?? '' }}">
  </div>
  <div class="form-group col-auto mb-2">
    <button type="submit" class="btn btn-secondary btn-sm">Filter</button>
    @if($selectedPeriod || ($search ?? ''))
...
<th class="border-top-0 py-2">Karyawan</th>
<th class="border-top-0 py-2">Periode</th>
<th class="border-top-0 py-2">Template</th>
<th class="border-top-0 py-2 text-center">Skor</th>
<th class="border-top-0 py-2 text-center">Grade</th>
<th class="border-top-0 py-2">Status</th>
<th class="border-top-0 py-2">Aksi</th>
</tr>
</thead>
<tbody>
...
@empty
<tr><td colspan="8" class="text-center text-muted py-4">Tidak ada data penilaian.</td></tr>
@endforelse
</tbody>
</table>
</div>
...
<div class="mt-3 d-flex justify-content-between align-items-center">
  <small class="text-muted">
    Menampilkan {{ $appraisals->firstItem() }}–{{ $appraisals->lastItem() }} dari {{ $appraisals->total() }} data
  </small>
  {{ $appraisals->links() }}
</div>
@endif
